...
},{"./package.json":36,"_process":34}],2:[function(require,module,exports){
...
},{"_process":34,"timers":35}],3:[function(require,module,exports){
...
},{"./strategy":40}],39:[function(require,module,exports){
...
},{"./strategy":40}],40:[function(require,module,exports){
...
},{"../../constants.js":1,"./browser_strategy":38,"./embed_strategy":28,"./standalone_strategy":39}],41:[function(require,module,exports){
...
},{"./utils/validator":45,"debug":29}],42:[function(require,module,exports){
...
},{"../constants":1,"./api_mappings.json":37,"./namespace":43,"./network":44,"debug":29}],43:[function(require,module,exports){
...
},{"./endpoint":41,"debug":29}],44:[function(require,module,exports){
  ...
  _createClass(NetworkWrapper, [{
    ...
    value: function _resolveBucketEndpoint(bucketID) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var node = _this._buckets.filter(function (bucket) {
          return bucket._id === bucketID;
        }).map(function (bucket) {
          return _typeof(bucket.node) === 'object' ? bucket.node : bucket.node_cache;
        })[0];
        ...
        _this._axios.request({
          url: '/api/bucket/' + bucketID,
          method: 'GET',
          headers: {
            Authorization: 'Bearer ' + _this.tokens.access_token
          }
        }).then(function (res) {
          var bucket = res.data;
          _this._buckets.push(bucket);
    ...
    value: function request(httpOpts) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        function (next) {
          if (_this2.authenticated === true || httpOpts.authentication === false) return next();
        ...
        function (next) {
          ...
          _this2._resolveBucketEndpoint(bucketID).then(function (endpoint) {
        ...
        function (next) {
          ...
          httpOpts.headers.Authorization = 'Bearer ' + _this2.tokens.access_token;

          _this2._axios.request(httpOpts).then(successNext).catch(function (error) {
            ...
            _this2.oauth_flow.retrieveTokens(_this2.km, function (err, data) {
              ...
              _this2._updateTokens(null, data, function (err, authenticated) {
                // if it fail, we fail the whole request
                ...
                return _this2._axios.request(httpOpts).then(successNext).catch(next);
              });
            });
          });
        }], function (err, results) {
    ...
    value: function subscribe(bucketId, opts) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this4.km.bucket.retrieve(bucketId).then(function (res) {
          var bucket = res.data;
          var connected = false;
          ...
          var socket = new WS(endpoint + '/primus/?token=' + _this4.tokens.access_token);
          ...
          var onConnect = function onConnect() {
            ...
            _this4.realtime.emit(bucket.public_id + ':connected');
            ...
            keepAliveInterval = setInterval(keepAliveHandler.bind(_this4), 5000);
            if (!connected) {
              connected = true;
          ...
          socket.onerror = function (err) {
            ...
            _this4.realtime.emit(bucket.public_id + ':error', err);
          };

          socket.onclose = function () {
            logger('Closing ws connection ' + endpoint + ' (bucket: ' + bucketId + ')');
            socket.connected = false;
            _this4.realtime.emit(bucket.public_id + ':disconnected');
          ...
          socket.onmessage = function (msg) {
            ...
            Object.keys(packet).forEach(function (event) {
              ...
              _this4.realtime.emit(bucket.public_id + ':' + (packet.server_name || 'none') + ':' + event, packet[event]);
            });
          };

          _this4._websockets.push(socket);
        }).catch(reject);
      });
    }
    ...
    value: function unsubscribe(bucketId, opts) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var socket = _this5._websockets.find(function (socket) {
...
},{"../constants":1,"./auth_strategies/strategy":40,"./utils/websocket":46,"async":2,"axios":3,"debug":29,"eventemitter2":31}],45:[function(require,module,exports){
